...
// Setting the variables        
    ...
    private $pagepath = 'contact/'; // Always provide a trailing slash ( '/' ) at the end !!!
    ...
    private $pagetitle = 'Contact'; // Always provide space dash space ( ' - ' ) at the end!!!
    // This is ment for the navigation to show the active status.
    public $firstactive = 'contact';
