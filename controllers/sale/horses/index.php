...
// Setting the variables        
    ...
    private $pagetitle = 'For Sale - Horses'; // Always provide space dash space ( ' - ' ) at the end!!!
    // This is ment for the navigation to show the active status.
    public $firstactive = 'sale';
    private $secondactive = 'horsesale';
    private $thirdactive = '';
...
//                           ];
    ...
    function index(){
          ...
          $this->view->render($this->viewpath.'horses', $this->setup); 
    }
