...
// Setting the variables        
    ...
    private $pagetitle = 'For Sale - Equipment'; // Always provide space dash space ( ' - ' ) at the end!!!
    // This is ment for the navigation to show the active status.
    public $firstactive = 'sale';
    private $secondactive = 'equipmentsale';
    private $thirdactive = '';
...
//                           ];
    ...
    function index(){
          ...
          $this->view->render($this->viewpath.'equipment', $this->setup); 
    }
