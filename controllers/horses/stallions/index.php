...
// Setting the variables        
    ...
    private $pagepath = 'horses/'; // Always provide a trailing slash ( '/' ) at the end !!!
    // The view used for this page
    private $viewpath = 'horses/'; // Always provide a trailing slash ( '/' ) at the end !!!
    // Setup needed for this page
    private $setup = 'main';
    // Basic for the page title
    private $pagetitle = 'Horses - Stallions'; // Always provide space dash space ( ' - ' ) at the end!!!
    // This is ment for the navigation to show the active status.
    public $firstactive = 'horses';
    private $secondactive = 'stallions';
    private $thirdactive = '';
...
//                           ];
    ...
    function index(){
          ...
          $this->view->render($this->viewpath.'stallions', $this->setup); 
    }
