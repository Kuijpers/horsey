...
// Setting the variables    
    ...
    private $pagepath = 'links/users/'; // Always provide a trailing slash ( '/' ) at the end !!!
    // The view used for this page
    private $viewpath = 'links/'; // Always provide a trailing slash ( '/' ) at the end !!!
    // Setup needed for this page
    private $setup = 'dashboard';
    // Basic for the page title
    private $pagetitle = 'Dashboard - Links'; // Always provide space dash space ( ' - ' ) at the end!!!
    // This is ment for the navigation to show the active status.
    public $firstactive = 'widgets';
    private $secondactive = 'links';
    private $thirdactive = '';
    ...
    private $breadcrumbactive = 'NAV_PAGES_LINKS';
