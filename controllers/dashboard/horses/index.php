...
// Setting the variables    
    ...
    private $pagepath = 'dashboard/horses/'; // Always provide a trailing slash ( '/' ) at the end !!!
    ...
    private $pagetitle = 'Dashboard - Horses '; // Always provide space dash space ( ' - ' ) at the end!!!
