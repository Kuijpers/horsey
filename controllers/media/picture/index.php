 ...
 * Within this class we handle everything needed for the Picture page
 *
...
// Setting the variables        
    ...
    private $pagepath = 'media/'; // Always provide a trailing slash ( '/' ) at the end !!!
    // The view used for this page
    private $viewpath = 'media/'; // Always provide a trailing slash ( '/' ) at the end !!!
    // Setup needed for this page
    private $setup = 'main';
    // Basic for the page title
    private $pagetitle = 'Media - Pictures'; // Always provide space dash space ( ' - ' ) at the end!!!
    // This is ment for the navigation to show the active status.
    public $firstactive = 'media';
    private $secondactive = 'pictures';
    private $thirdactive = '';
    ...
    function __construct(){
        parent::__construct(); // Insert __construct method from Class controller
            ...
            //Debug::sentence("picture controller");
...
//                           ];
    ...
    function index(){
          ...
          $this->view->render($this->viewpath.'pictures', $this->setup); 
    }
