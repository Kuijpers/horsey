 ...
 * Within this class we handle everything needed for the help page
 * 
...
class Help extends Controller{
    ...
    public function __construct(){
        parent::__construct(); // Insert __construct method from Class controller
            ...
            Debug::sentence("help controller");
...
//                           ];
    ...
    public function index(){
          $this->view->title = 'Dashboard - Help';
          $this->view->topactive = 'dashboard';
          $this->view->active = 'dashboard';
          $this->view->render('help/index', 'dashboard'); 
    }
