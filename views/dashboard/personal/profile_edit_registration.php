...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
              <h3 class="panel-title"><b><?php echo $lang['PERSONAL_PROFILE_EDIT_REGISTRATION_TITLE'];?></b></h3>
              <?php echo $lang['PERSONAL_PROFILE_EDIT_REGISTRATION_MESSAGE'];?>
          </div>
          <div class="panel-body">
              <form action="<?php echo URL . $pagepath ?>update_registration/" method="POST" name='edit_registration'>
...
foreach ($user_details[0] as $key => $value) {
    switch ($key) {
        ...
        case "user_email":
            ...
            echo $lang['PERSONAL_PROFILE_'.strtoupper($key)];
            echo "</strong></td><td>";
            echo "<input type='email' class='form-control' name='$key' value='$value' />";
            echo "</td></tr>";
            break;
        case "user_telephone":
            echo "<tr><td><strong>";
            echo $lang['PERSONAL_PROFILE_'.strtoupper($key)];
            echo "</strong></td><td>";
            echo "<input type='tel' class='form-control' name='$key' value='$value' />";
            echo "</td></tr>";
            break;
        default:
            echo "<tr><td><strong>";
